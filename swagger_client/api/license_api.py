...
class LicenseApi(object):
    ...
    def create_license(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_license(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_license_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_license_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_license_with_http_info(self, **kwargs):  # noqa: E501
        """Creates a new custom license  # noqa: E501

        <p>Requires permission <strong>SYSTEM_CONFIGURATION</strong></p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_license_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def delete_license(self, license_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str license_id: The SPDX License ID of the license to delete (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_license_with_http_info(license_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_license(self, license_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str license_id: The SPDX License ID of the license to retrieve (required)
        :return: License
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_license_listing(self, **kwargs):  # noqa: E501
        """Returns a concise listing of all licenses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_license_listing(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_license_listing_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_license_listing_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_license_listing_with_http_info(self, **kwargs):  # noqa: E501
        """Returns a concise listing of all licenses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_license_listing_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_license_listing" % key
                )
            params[key] = val
        del params['kwargs']
